...
//    @Operation(summary = "포트폴리오 아이디로 채팅방 생성")
//    public ResponseEntity<ChatRoomDTO.Response> createChatRoomByPortfolioId(Long portfolioId) {
//        ChatRoomDTO.Response createdChatRoom = chatRoomService.createChatRoomByPortfolioId(portfolioId);
...
//    public ResponseEntity<ChatRoomDTO.Response> getChatRoomById(Long chatRoomId) {
//        ChatRoomDTO.Response chatRoomResponse = chatRoomService.getChatRoomById(chatRoomId);
